...
export const projects: Project[] = [
  {
    ...
    title: "FastVote",
    description:
      "회원가입 없이 바로 투표를 만들고, 링크 공유만으로 실시간 결과를 확인할 수 있는 익명 투표 서비스입니다.",
    ...
    category: "fullstack",
    outcome: "빠른 의사결정이 필요한 상황에서 생성, 공유, 참여, 결과 확인까지의 흐름을 짧고 단순하게 만든 작업",
    detail: {
      overview:
        "FastVote는 빠른 의사결정이 필요한 상황을 위해 만든 실시간 익명 투표 서비스입니다. 지인 모임에서 메뉴를 정하거나, 팀 내에서 가볍게 의견을 모으거나, 커뮤니티에서 즉시 투표를 받아야 할 때 가입과 설정 과정이 길어지면 참여율이 떨어진다고 판단했습니다. 그래서 투표 생성, 링크 공유, 참여, 결과 확인까지의 흐름을 최대한 짧고 단순하게 설계했습니다.",
      background:
        "FastVote는 빠르게 의견을 모아야 하는 순간을 위해 만든 실시간 익명 투표 서비스입니다. 친구들과 메뉴를 정하거나 팀 안에서 가볍게 의견을 모을 때, 가입이나 설정 과정이 길어지면 오히려 참여가 줄어든다고 느꼈습니다. 그래서 투표를 만들고 링크를 공유하고 결과를 확인하는 흐름이 최대한 짧고 자연스럽게 이어지도록 구성했습니다.",
