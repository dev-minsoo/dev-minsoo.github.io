...
export const projects: Project[] = [
  {
    ...
    detail: {
      overview:
        "FastVote는 친구나 회사 동료와 빠르게 의견을 모아야 할 때 바로 사용할 수 있도록 만든 투표 플랫폼입니다. 로그인 없이 투표를 생성하고 링크를 공유할 수 있으며, 비공개 투표와 공개 투표를 모두 지원합니다. 모바일 환경에서도 자연스럽게 사용할 수 있도록 반응형 UI를 적용했습니다.",
      implementation: [
        "UUID 기반 링크를 사용해 로그인 없이도 투표를 만들고 바로 공유할 수 있게 했습니다.",
        "Redis TTL과 WebSocket을 적용해 짧게 열리는 투표도 실시간으로 결과가 반영되도록 구성했습니다.",
        "비공개 투표와 공개 투표를 모두 지원하고, 모바일 환경에서도 무리 없이 사용할 수 있도록 반응형 UI를 적용했습니다.",
      ],
      impact: [
        "회의나 약속처럼 빠르게 결정을 내려야 하는 상황에서 바로 사용할 수 있게 했습니다.",
        "가입이나 설치 없이 링크만 공유하면 참여할 수 있어 진입 장벽을 낮췄습니다.",
      ],
    },
    links: {
